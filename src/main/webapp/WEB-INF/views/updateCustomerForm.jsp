...
<form:form action="/saveUpdateCustomer" method="post" modelAttribute="customer" class="form-group">
    <div class="table-responsive">
        ...
        <tr>
            ...
            <form:input path="customerName"  class="form-control" required="required" type="text"/>
        </td>
            <td>
            <form:label path="address" >Address:</form:label>
            <form:input path="address"  class="form-control" required="required" type="text"></form:input>
            </td>
            <td>
                <form:label path="comments" >Comment:</form:label>
                <form:input path="comments"  class="form-control" type="text"></form:input>
            </td>
        ...
        <tr>
             ...
             <td>
               <a href="/customers"> <button class="btn btn-secondary bouton-image monBoutonGoBack" value="Go Customers" >Go Customers</button></a>
             </td>
