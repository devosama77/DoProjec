...
public class HibernateConfig extends WebSecurityConfigurerAdapter {
	...
	public LocalSessionFactoryBean getSessionFactory() {
		...
		//factoryBean.setAnnotatedClasses(Salary.class);
		 factoryBean.setAnnotatedClasses(Customer.class, Driver.class,Book.class, Remark.class, SizeTanker.class, TypeLiquid.class, NumberTanker.class);
		return factoryBean;
	}
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/").permitAll()
				...
				.and()
//				.authorizeRequests().antMatchers("/welcom**").hasRole("USER")
//				.and()
